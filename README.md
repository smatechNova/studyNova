...
See `infra/api-production-readiness.md` before pointing a Play Store build at a stable backend URL.
See `infra/render-closed-test-deployment.md` for the first hosted backend execution path.
